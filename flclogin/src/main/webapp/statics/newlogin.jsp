...
<div class="main-body">
    <div class="login-main">
        ...
        <form class="layui-form login-bottom" method="post" action="">
            <div class="center">
                <div class="item">
                    <span class="icon icon-2"></span>
                    <input type="text" name="username" lay-verify="required" value="" placeholder="请输入登录账号" maxlength="24"/>
                </div>

                <div class="item">
                    <span class="icon icon-3"></span>
                    <input type="password" name="password" lay-verify="required" value="" placeholder="请输入密码" maxlength="20">
